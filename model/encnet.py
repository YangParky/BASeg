...
from encoding.models.base import BaseNet
from encoding.models.fcn import FCNHead
...
def main():
    ...
    model = get_encnet('ade20k', 'resnet101', pretrained=False, aux=True,
                          base_size=640, crop_size=520)

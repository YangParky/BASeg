...
class BASeg(nn.Module):
    def __init__(self, num_classes, BatchNorm=nn.BatchNorm2d, layers=50, 
        ...
        self.edge_detect = Edge_Detect(in_channels, embed_dim, num_classes, BatchNorm)
        self.cont_aggreg = Context_Aggregation(in_channels[-1]+embed_dim, num_classes, embed_dim)

        self.edge_sege = nn.Sequential(

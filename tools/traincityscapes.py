...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/cityscapes/cityscapes_baseg101.yaml', help='config file')
    parser.add_argument('opts', help='see config/ade20k/cityscapes_baseg101.yaml for all options', default=None,
